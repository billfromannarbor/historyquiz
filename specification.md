...
This is a history quiz game.  
The questions are intended to be harder based on how you answer the previous questions.
Each segment has three levels of questions.  
Level 1 is the easiest, and Level 3 is the hardest. 
You get Level 1 if you answered the two previous questions incorrectly.  You get Level 2 if you answered one of the last two questions correctly.  You get Level 3 if you answered both the last two questions correctly.
The first question will always be Level 3 with 200 points.
The second question will be either Level 2 or Level 3 with 100 or 200 points based on how the user answered the first question. (If they answered it correctly, the second question is Level 2, if they answered it incorrectly, the second question is Level 3.)
Level 1 questions are worth 50 points each, Level 2 questions are worth 100 points each, and Level 3 questions are worth 200 points each.
...
The users score should be displayed prominently at the top of the screen.

The game is a simple html/css/javascript game that runs in the browser.

The landing page will display the story premise and a button to start the game.  When the users clicks start the game, the first segment is displayed.
...
story image: images/otherkitten_history.png
...
## Segment 1: The Disappearing Declaration
Images: images/otherkitten_independencehall.png
...
To stabilize time and move forward, you must restore a missing portion of the Declaration of Independence before the document is finalized. You scan the room—John Adams, Thomas Jefferson, and Benjamin Franklin are arguing over phrasing. You suspect that the missing part must be a critical phrase.
...
## Segment 2: The Vanishing Victory
Images: images/otherkitten_rome.png
...
Otherkitten lands beside you gracefully, its tail flicking as if sensing trouble.
...
To set history right, you must identify the missing warning before it’s too late.

The Puzzle:

Before Julius Caesar arrives, you must restore the historically accurate warning that he was meant to receive.

Question (If you answered the first question incorrectly):
...
Question (If you answered the first question correctly):
...
## Segment 3: The Mystery of the Missing Map
Images: images/otherkitten_santa_maria.png
...
Before the ship can sail, you must restore the missing navigation information.
...
Question Level 2 (Answered one of the last two questions correctly):
...
Question Level 3 (Answered the last two questions correctly):
...
## Segment 4: The Pharaoh’s Lost Inscription
...
The Puzzle:
To stabilize history, you must identify the correct missing hieroglyphic inscription for Tutankhamun’s tomb.
